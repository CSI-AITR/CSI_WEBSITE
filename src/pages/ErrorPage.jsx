...
function ErrorPage(props) {
  return (
    ...
    <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
      <p className="text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-richblack-25">
        {"404"}
      </p>
      <p className="text-4xl md:text-5xl lg:text-6xl text font-bold tracking-wider text-richblack-25 mt-2">
        {"Page Not Found"}
      </p>
      <p className="text-lg md:text-xl lg:text-2xl text-richblack-25 my-12">
        {"Sorry, the page you are looking for could not be found."}
      </p>
      <Link
        to={"/"}
        className="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-richblack-25 px-4 py-2 rounded transition duration-150"
        title="Return Home"
      >
        <svg
